...
public class ListPresidentAdapter extends RecyclerView.Adapter<ListPresidentAdapter.CategoryViewHolder>{
    ...
    @Override
    public CategoryViewHolder onCreateViewHolder(ViewGroup perent, int viewType){
        View itemRow = LayoutInflater.from(perent.getContext()).inflate(R.layout.item_row_president, perent, false);
    ...
    public void onBindViewHolder(CategoryViewHolder holder, int position){
        ...
        Glide.with(context).load(getListPresident().get(position).getPhoto()).override(55,55).crossFade().into(holder.imgPhoto);
    }
